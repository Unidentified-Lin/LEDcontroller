...
public class BluetoothConnectService {
	...
	public static final int STATE_CONNECTIONLOST = 3;
	...
	private void connectionFailed() {
		...
		Message msg1 = mHandler.obtainMessage(MainActivity.MSG_TOAST);
		Message msg2 = mHandler.obtainMessage(MainActivity.MSG_DISMISS);
	...
	private void connectionLost() {
		// Send a failure message back to the Activity
		Message msg = mHandler.obtainMessage(MainActivity.MSG_TOAST);
		Bundle bundle = new Bundle();
